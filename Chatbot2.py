...
df = pd.read_csv('C:/Users/Xyphrus Von Keith/Documents/Xyphrus/SY 2021-2022/2nd Sem/2nd Sem Subjects/Thesis Writing 1/Thesis Codes/codes/Chatbot_Responses.csv')

print("Hello I am Siri")
